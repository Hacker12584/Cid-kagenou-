...
async function fetchFromAI(url, params) {
    try {
        ...
        if (data && (data.gpt4 || data.reply || data.response || data.answer || data.message)) {
            ...
            console.log("AIv2 Response:", response);
            return response;
        } else {
...
module.exports = {
    config: {
        ...
        shortDescription: 'AIv2 to answer any question',
    },
    onStart: async function ({ api, event, args }) {
        ...
        try {
            ...
            lastResponseMessageID = messageID;
            api.sendMessage(`⚔⚔ | Cid kagenou 𝙰𝚒\n━━━━━━━━━━━━━━━━\n${response}\n━━━━━━━━━━━━━━━━`, event.threadID, messageID);
        } catch (error) {
    ...
    onChat: async function ({ event, message, api }) {
        ...
        // Check if the message is a reply to the bot's message or starts with "aiv2"
